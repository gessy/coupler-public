...
public class RegionPreset {
    ...
    private static List<Region> getRussia() {
        ...
        regions.add(new Region("Vologda", null, 59.281179d, 40.033205d, 59.165494d, 39.727304d, MIN_ZOOM, MAX_ZOOM));
        ...
        regions.add(new Region("Tomsk", null, 56.584865d, 85.125355d, 56.394271d, 84.887759d, MIN_ZOOM, MAX_ZOOM));
        ...
        regions.add(new Region("Kazan", null, 55.923795d, 49.318112d, 55.658151d, 48.821398d, MIN_ZOOM, MAX_ZOOM));
    ...
    private static List<Region> getEstonia() {
        ...
        regions.add(new Region("Tartu", null, 58.413400d, 26.801452d, 58.336059d, 26.667080d, MIN_ZOOM, MAX_ZOOM));
        return regions;
    }
    ...
    private static List<Region> getGermany() {
        ...
        regions.add(new Region("Hanover", null, 52.455063d, 9.921061d, 52.302231d, 9.599596d, MIN_ZOOM, MAX_ZOOM));
        regions.add(new Region("Dresden", null, 51.181463d, 13.967587d, 50.970492d, 13.575631d, MIN_ZOOM, MAX_ZOOM));
        regions.add(new Region("Nuremberg", null, 49.543949d, 11.214742d, 49.328651d, 10.980387d, MIN_ZOOM, MAX_ZOOM));
    ...
    private static List<Region> getItaly() {
        ...
        regions.add(new Region("Florence", null, 44.243225d, 11.768970d, 43.445415d, 10.700848d, MIN_ZOOM, MAX_ZOOM));
        regions.add(new Region("Bologna", null, 44.816285d, 11.844709d, 44.060657d, 10.789684d, MIN_ZOOM, MAX_ZOOM));
        regions.add(new Region("Milan", null, 45.651902d, 9.546299d, 45.269224d, 8.698749d, MIN_ZOOM, MAX_ZOOM));
    ...
    private static List<Region> getFrance() {
        ...
        regions.add(new Region("Lyon", null, 45.809546d, 4.901210d, 45.705493d, 4.769751d, MIN_ZOOM, MAX_ZOOM));
